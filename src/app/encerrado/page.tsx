...
export default function Page() {
  ...
  return (
    <div className="font-montserrat bg-black text-white min-h-screen relative overflow-hidden">
      {showModal && <WhatsappModal onClose={handleCloseModal} />}
      {/* Content wrapper */}
      <div className="relative z-10">
        {/* Aviso de Vagas Encerradas */}
        <div className="w-full bg-black border-b border-neutral-800/50">
          <div className="max-w-4xl mx-auto px-4 py-3 text-center">
            <div className="flex flex-col md:flex-row items-center justify-center gap-1 md:gap-2">
              ...
              <span className="text-green-400 text-sm">
                FIP disponível no valor original
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="max-w-4xl mx-auto bg-black/30 border border-neutral-800/50 rounded-2xl p-8 mb-8">
              ...
              <p className="text-neutral-300/80 text-sm text-center max-w-3xl mx-auto border-t border-neutral-800/50 pt-4 mt-8">
                Atenção: As vagas promocionais foram encerradas. Agora você pode adquirir o curso no valor original sem os bônus exclusivos.
              </p>
          </div>
        </div>
      </section>
      ...
      <section id="planos" className="py-16 px-4 bg-black">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Plano Original - Agora Disponível */}
              <div className="order-2 md:order-1 relative border-2 border-white/20 rounded-2xl p-8 bg-gradient-to-b from-white/[0.03] to-transparent backdrop-blur-sm">
                {/* Tag de Disponível */}
              ...
              {/* Plano Promocional - Indisponível */}
              <div className="order-1 md:order-2 relative border-2 border-neutral-800/50 rounded-2xl p-8 bg-gradient-to-b from-neutral-900/30 to-transparent backdrop-blur-sm opacity-50">
                ...
                <div className="text-center mt-8 mb-8">
                  <h3 className="text-2xl font-semibold bg-gradient-to-r from-neutral-400 via-neutral-400 to-neutral-400/90 bg-clip-text text-transparent">
                    VALOR REDUZIDO
                  </h3>
                  <h3 className="text-2xl font-semibold bg-gradient-to-r from-neutral-400 via-neutral-400 to-neutral-400/90 bg-clip-text text-transparent mt-1">
                    + TODOS BÔNUS
                  </h3>
                ...
                <ul className="space-y-4 mb-8">
                  <li className="flex items-start gap-3 text-sm">
                    ...
                    <span className="text-neutral-400">Formação Completa do Zero ao Avançado <span className="block text-neutral-400/80 text-xs mt-1">(Valor Original: R$1.997)</span></span>
                  </li>
                  <li className="flex items-start gap-3 text-sm">
                    <span className="text-neutral-400 mt-1">✓</span>
                    <span className="text-neutral-400">Acesso a Plataforma da K17 <span className="block text-neutral-400/80 text-xs mt-1">(Valor Original: R$997)</span></span>
                  </li>
                  <li className="flex items-start gap-3 text-sm">
                    <span className="text-neutral-400 mt-1">✓</span>
                    <span className="text-neutral-400">1 ano de acesso ao Futuros Tech <span className="block text-neutral-400/80 text-xs mt-1">(Valor Original: R$2.997)</span></span>
                  </li>
                  <li className="flex items-start gap-3 text-sm">
                    <span className="text-neutral-400 mt-1">✓</span>
                    <span className="text-neutral-400">BlackBook <span className="block text-neutral-400/80 text-xs mt-1">(Valor Original: R$897)</span></span>
                  </li>
                  <li className="flex items-start gap-3 text-sm">
                    <span className="text-neutral-400 mt-1">✓</span>
                    <span className="text-neutral-400">Bônus Secreto para Caixa Rápido <span className="block text-neutral-400/80 text-xs mt-1">(Valor Original: R$4.000)</span></span>
                  </li>
                </ul>
