...
export default function Page() {
  ...
  return (
    <div className="font-montserrat bg-black text-white min-h-screen relative overflow-hidden">
      {/* Fixed Alert at Top */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-green-600 to-green-500 text-white text-center py-2 px-4 shadow-lg">
        <div className="flex items-center justify-center gap-2">
          <div className="w-2 h-2 bg-white rounded-full animate-pulse"></div>
          <span className="text-sm font-medium tracking-wide">
            PLANO MENSAL E TRIMESTRAL DISPONÍVEIS!
          </span>
          <div className="w-2 h-2 bg-white rounded-full animate-pulse"></div>
        </div>
      </div>
      ...
      <div className="relative z-10 pt-12">
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          {/* CTA Button - Updated with green colors and border gradient effect */}
          <div className="flex justify-center mt-8">
            <a
              href="#planos"
              className="group relative overflow-hidden px-8 py-3 bg-green-500/90 hover:bg-green-500 border border-green-400/50 rounded-lg transition-all duration-300 shadow-lg shadow-green-500/20"
            >
              {/* Animated border gradient */}
              <div className="absolute inset-0 rounded-lg opacity-75">
                <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-transparent via-green-300/60 to-transparent animate-[spin_3s_linear_infinite] blur-[1px]" />
              </div>
              
              {/* Inner border for clean look */}
              <div className="absolute inset-[1px] bg-green-500/90 group-hover:bg-green-500 rounded-[7px] transition-colors duration-300" />
              
              {/* Button text */}
              <span className="relative text-sm font-semibold tracking-wider uppercase text-white transition-colors duration-300 z-10">
                {language === 'pt' ? 'ENTRAR AGORA' : 'JOIN NOW'}
              </span>
            </a>
          </div>
        </div>
