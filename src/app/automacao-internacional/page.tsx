...
export default function GrupoAutomacao() {
  ...
  useEffect(() => {
    redirectTimerRef.current = window.setTimeout(() => {
      window.location.href = "https://chat.whatsapp.com/HJnshcKnhbi73LA3x3zgJZ";
    }, 10000);
    return () => {
  ...
  // Countdown display for auto-redirect
  useEffect(() => {
  ...
  return (
    <div className={`${inter.className} bg-black text-gray-100 min-h-screen relative overflow-hidden`}>
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 flex flex-col items-center">
        ...
        <div className="mb-16">
          <a 
            href="https://chat.whatsapp.com/HJnshcKnhbi73LA3x3zgJZ"
            target="_blank"
          ...
          {secondsLeft > 0 && (
            <p className="mt-3 text-sm text-gray-400 text-center">
              Redirecionando em <span className="tabular-nums text-gray-200">{secondsLeft}s</span>...
            </p>
          )}
        </div>
