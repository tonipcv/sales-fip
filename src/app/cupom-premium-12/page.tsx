...
export default function Page() {
  ...
  const [vagasRestantes] = useState(3);
  ...
  return (
    <div className="font-montserrat bg-black text-white min-h-screen relative overflow-hidden">
      {/* Banner fixo no topo */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-green-500/20 via-green-500/10 to-green-500/20 backdrop-blur-sm border-b border-green-500/20">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 text-center">
            ...
            <p className="text-white/90 text-sm font-medium">
              SOMENTE 3 VAGAS DISPONIBILIZADAS COM DESCONTO - QUEM FOR RÁPIDO LEVA!
            </p>
          </div>
        </div>
      </div>
        ...
        <section id="planos" className="py-16 px-4 bg-black">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              {/* Plano Promocional - Agora Liberado */}
              <div className="order-1 md:order-2 relative border-2 border-green-500/20 rounded-2xl p-8 bg-gradient-to-b from-neutral-900/30 to-transparent backdrop-blur-sm">
                {/* Tag de Oferta */}
                ...
                <div className="flex justify-center gap-4 mt-4 mb-6">
                  ...
                  <div className="bg-green-500/10 border border-green-500/20 rounded-lg px-4 py-2">
                    ...
                    <p className="text-green-300 text-xl text-center font-bold mt-1">
                      {vagasRestantes}
                    </p>
                  </div>
                </div>
                ...
                <div className="text-center pt-6 border-t border-neutral-800/30">
                  ...
                  <p className="text-xs text-green-400">Acabando as vagas o link sairá do ar, esse link é único.</p>
                </div>
              </div>
