...
// Two pixel IDs to use for Facebook tracking
const FB_PIXEL_ID_1 = '1203701254882500';
const FB_PIXEL_ID_2 = '737017615149021'; // The original ID from the FacebookPixel component

export default function DualFacebookPixel() {
  return (
    <>
      {/* First Facebook Pixel */}
